...
// HDR detection — covers what exifr can surface today (XMP-driven HDR
// JPEGs). HEIC / AVIF nclx and PNG cICP need a separate ISOBMFF / chunk
// parser, queued for v0.3.0.
